...
import { AgentMemoryTool } from '../tools/agent-memory.js';
...
export class Config {
  ...
  constructor(params: ConfigParameters) {
    ...
    this.watchEnabled = params.watch ?? false;
  ...
  getUserMemory(): string | HierarchicalMemory {
    ...
    if (typeof this.userMemory === 'string') {
      return {
        global: this.userMemory,
        soul: context.soul,
        user: context.user,
      };
    }
  ...
  async createToolRegistry(): Promise<ToolRegistry> {
    ...
    maybeRegister(AgentMemoryTool, () =>
      registry.registerTool(new AgentMemoryTool(this.messageBus)),
    );
    maybeRegister(MemorySearchTool, () =>
      registry.registerTool(new MemorySearchTool(this.messageBus)),
    );
